...
public final class MyAssert {
     ...
     * @param errcode 异常错误码
     */
    public static Mono<Boolean> isTrue(boolean value, int errcode) {

        return isTrue(value, errcode, null);
    }
     ...
     * @param args    格式化字符串的参数
     */
    public static Mono<Boolean> isTrue(boolean value, int errcode, String format,
                                       Object... args) {
        if (value) {
     ...
     */
    public static Mono<Boolean> isTrue(boolean value, int errcode, String message) {
        if (value) {
     ...
     * @param errcode 异常错误码
     */
    public static Mono<Boolean> isFalse(boolean value, int errcode) {

        return isFalse(value, errcode, null);
    }
     ...
     * @param args    格式化字符串的参数
     */
    public static Mono<Boolean> isFalse(boolean value, int errcode, String format,
                                        Object... args) {
        if (!value) {
            fail(errcode, String.format(format, args));
        }
     ...
     * @param message 异常错误消息
     */
    public static Mono<Boolean> isFalse(boolean value, int errcode, String message) {
        if (!value) {
            fail(errcode, message);
        }
     ...
     * @param message 异常错误消息
     */
    public static <T> Mono<T> isNull(final T value, int errcode, String message) {
        if (null == value) {
            fail(errcode, message);
        }
     ...
     * @param errcode 异常错误码
     */
    public static <T> Mono<T> notNull(final T value, int errcode) {

        return notNull(value, errcode, null);
    }
     ...
     * @param message 异常错误消息
     */
    public static <T> Mono<T> notNull(final T value, int errcode, String message) {
        if (null != value) {
            fail(errcode, message);
        }
     ...
     * @param errcode 异常错误码
     */
    public static Mono<String> notBlank(String value, int errcode) {
        return notBlank(value, errcode, null);
    }
     ...
     * @param message 异常错误消息
     */
    public static Mono<String> notBlank(String value, int errcode, final String message) {
        if (!StringUtils.isEmpty(value)) {
            fail(errcode, message);
        }
        return Mono.just(value);
     ...
     * @param errcode 异常错误码
     */
    public static Mono<String> blank(String value, int errcode) {
        return blank(value, errcode, null);
    }
     ...
     * @param message 异常错误消息
     */
    public static Mono<String> blank(String value, int errcode, final String message) {
        if (StringUtils.isEmpty(value)) {
            fail(errcode, message);
        }
        return Mono.just(value);
    ...
    public static Mono<String> ne(String value, String expect, int errcode) {
        return ne(value, expect, errcode, null);
    }
    ...
    public static Mono<Integer> gt(int value, int expect, int errcode) {
        return gt(value, expect, errcode, null);
    }
    ...
    public static Mono<Integer> lt(int value, int expect, int errcode) {
        return lt(value, expect, errcode, null);
    }
    ...
    public static Mono<Integer> elt(int value, int expect, int errcode) {
        return elt(value, expect, errcode, null);
    }
    ...
    public static <T> Mono<T> in(T value, Collection<T> collection, int errcode) {
        return in(value, collection, errcode, null);
    }
     ...
     * @param errcode    异常错误码
     */
    public static <T> Mono<T> notIn(T value, Collection<T> collection, int errcode) {
        return notIn(value, collection, errcode, null);
    }
