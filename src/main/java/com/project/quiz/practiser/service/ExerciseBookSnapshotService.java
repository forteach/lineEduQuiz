...
import com.project.quiz.practiser.web.req.FindAnswerStudentReq;
import com.project.quiz.practiser.web.req.GradeAnswerReq;
import com.project.quiz.practiser.web.req.findExerciseBookReq;
import com.project.quiz.practiser.web.resp.AnswerResp;
import com.project.quiz.practiser.web.resp.BigQuestionExerciseBookResp;
import com.project.quiz.practiser.web.vo.AnswerVo;
import com.project.quiz.practiser.web.vo.UnwindedExerciseAnswerQuestionBook;
import com.project.quiz.problemsetlibrary.domain.BigQuestionExerciseBook;
import com.project.quiz.problemsetlibrary.service.BigQuestionExerciseBookService;
    ...
    private Mono<Boolean> judgedResult(final AnswerVo answerVo, final String questionId, final String answer) {
        ...
        return bigQuestionVos.flatMapMany(Flux::fromIterable)
                ...
                .flatMap(questionExamEntity -> {
                    ...
                    BeanUtil.copyProperties(questionExamEntity, bigQuestion);
